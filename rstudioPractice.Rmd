...
```{r Exercise 8.7}
car_models <- c("Duster 360", "Lincoln Continental", "Maserati Bora")
row_indices <- which(rownames(mtcars) %in% car_models)

horsep <- mtcars[row_indices, "hp"]
...
```{r Exercise 9.4}
mtcars_copy <- mtcars[, !colnames(mtcars) %in% "am"]
```
