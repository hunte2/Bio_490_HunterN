...
```{r Exercise 1.1}
clinical <- read.csv("/Users/hunter/Downloads/clinicaldata.Rmd")
```
...
write.csv(clinical, "/Users/hunter/Downloads/brca_clinical_data.csv", row.names = FALSE)
```
...
```{r Exercise 2.1}
maf_query <- GDCquery(project)
    project = "clinicaldata.Rmd"
